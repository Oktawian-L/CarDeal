...
public class Book extends GenericModel {
    ...
    @ToOne(joinProperty = "publisherId")
    ...
    @Generated(hash = 402545835)
    public Book(Long id, String title, long authorId, long categoryId, long publisherId,
            long languageId, Double price, Double promotionalPrice, byte[] cover, Long releaseDate) {
        this.id = id;
        this.title = title;
    ...
    /** To-one relationship, resolved on first access. */
    @Generated(hash = 893233518)
    public Publisher getPublisher() {
        long __key = this.publisherId;
        if (publisher__resolvedKey == null || !publisher__resolvedKey.equals(__key)) {
            final DaoSession daoSession = this.daoSession;
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 329602816)
    public void setPublisher(@NotNull Publisher publisher) {
        if (publisher == null) {
            throw new DaoException(
                    "To-one property 'publisherId' has not-null constraint; cannot set to-one to null");
        }
        synchronized (this) {
            this.publisher = publisher;
            publisherId = publisher.getId();
            publisher__resolvedKey = publisherId;
        }
    }

    /** To-one relationship, resolved on first access. */
    @Generated(hash = 573099828)
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 983250276)
    public void setLanguage(@NotNull Language language) {
        if (language == null) {
            throw new DaoException(
                    "To-one property 'languageId' has not-null constraint; cannot set to-one to null");
        }
        synchronized (this) {
