...
public class DatabaseInitializer {
    ...
    public static void init(DaoSession daoSession, Context context){
        ...
        Book product1 = new Book("Camaro", "Chevrolet", "Sport", 3000.99);
        Book product2 = new Book("Camaro", "Chevrolet", "Sport", 3000.99);
        Book product3 = new Book("Camaro", "Chevrolet", "Sport", 3000.99);
        Book product4 = new Book("Camaro", "Chevrolet", "Sport", 3000.99);
        Book product5 = new Book("Camaro", "Chevrolet", "Sport", 3000.99);
        Book product6 = new Book("Camaro", "Chevrolet", "Sport", 3000.99);
        Book product7 = new Book("Camaro", "Chevrolet", "Sport", 3000.99);
        Book product8 = new Book("Camaro", "Chevrolet", "Sport", 3000.99);
        Book product9 = new Book("Camaro", "Chevrolet", "Sport", 3000.99);
       ...
       daoSession.getBookDao().insert(product12);
        ...
        details.setDescription("Camaro opis");
